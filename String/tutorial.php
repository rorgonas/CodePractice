...
<html>
	...
	<body>
		...
		$pos = strpos($text1, "a");
		echo "<br />First occurance in $text1 is: " .$pos;

		$pos = strpos($text2, "a");
		echo "<br />First occurance in $text2 is: " .$pos;

		$pos = strrpos($text1, "a");
		echo "<br />First last occurance in $text1 is: " .$pos;

		$pos = strrpos($text2, "a");
		if ($pos === true) {
			echo "<br />First last occurance in $text2 is: " .$pos;
		}
		echo "<br />No occurance in $text2 of 'a'";
		...
		echo "<br />" .substr($text, 2);

		$data = "2013/01/11";
		echo "<br />".substr($data, 0,4);
